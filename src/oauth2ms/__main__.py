...
def build_app_state_from_credentials(crypt, credentials_file):
    ...
    try:
        ...
        print("Not a valid json file or it is encrypted. Maybe add/remove the -e argument?")
        sys.exit(1)
...
def main():
    ...
    if app_state is None:
        app_state, token = build_new_app_state(crypt, no_browser=cmdline_args.no_browser)
